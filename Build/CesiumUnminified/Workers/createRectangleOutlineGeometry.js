...
define(['./when-208fe5b0', './Cartesian2-b4b7b0b3', './GeometryOffsetAttribute-3497d4dd', './Transforms-4e23335e', './ComponentDatatype-ce69354e', './Check-5e798bbf', './GeometryAttribute-02d80cc5', './GeometryAttributes-b0b294d8', './IndexDatatype-da7c58eb', './Math-8386669c', './PolygonPipeline-2dfc6d4a', './RectangleGeometryLibrary-ea3a36d7', './RuntimeError-7f634f5d', './WebGLConstants-76bb35d1', './EllipsoidRhumbLine-73a4e3eb'], function (when, Cartesian2, GeometryOffsetAttribute, Transforms, ComponentDatatype, Check, GeometryAttribute, GeometryAttributes, IndexDatatype, _Math, PolygonPipeline, RectangleGeometryLibrary, RuntimeError, WebGLConstants, EllipsoidRhumbLine) { 'use strict';
