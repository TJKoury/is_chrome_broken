...
define(['./Cartesian2-b4b7b0b3', './AttributeCompression-9711314b', './Math-8386669c', './IndexDatatype-da7c58eb', './createTaskProcessorWorker', './Check-5e798bbf', './when-208fe5b0', './WebGLConstants-76bb35d1'], function (Cartesian2, AttributeCompression, _Math, IndexDatatype, createTaskProcessorWorker, Check, when, WebGLConstants) { 'use strict';
