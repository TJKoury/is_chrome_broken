...
define(['./Transforms-d2b6be42', './BoxGeometry-ad201ccf', './Cartesian2-29c15ffd', './Color-be59d11d', './CylinderGeometry-f8f9f156', './when-f31b6bd1', './EllipsoidGeometry-0fe44162', './IndexDatatype-15184ec8', './createTaskProcessorWorker', './Check-ed9ffed2', './Math-03750a0b', './RuntimeError-c7c236f3', './GeometryOffsetAttribute-f6456e72', './ComponentDatatype-2ec73936', './WebGLConstants-34c08bc0', './GeometryAttribute-8c2091fc', './GeometryAttributes-e973821e', './VertexFormat-44d61ac9', './CylinderGeometryLibrary-a5923d2f'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
